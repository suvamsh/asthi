      ...
      <Card className="w-full max-w-md text-center">
        <div className="mb-6">
          <div className="flex items-center justify-center gap-2 mb-2">
            <Wallet className="w-8 h-8 text-[#4fc1ff]" />
            <h1 className="text-3xl font-bold text-[#e0e0e0]">Asthi</h1>
          </div>
          <p className="text-[#8a8a8a]">Track your net worth with ease</p>
        </div>
        ...
        <p className="text-xs text-[#6e6e6e] mt-6">
          By signing in, you agree to securely store your financial data
        </p>
      </Card>
    </div>
  );
